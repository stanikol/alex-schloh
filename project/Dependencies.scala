...
//    val postgres = "com.github.mauricio" %% "postgresql-async" % "0.2.21" exclude("io.netty", "netty-all")
  ...
  object Shop {
//        val quill =  "io.getquill" %% "quill-async-postgres" % "1.1.0"
//    val quill =  "io.getquill" %% "quill-jdbc" % "0.10.0"
...
//    val postgres = "org.postgresql" % "postgresql" % "9.4-1206-jdbc4"
    val play_slick = "com.typesafe.play" %% "play-slick" % "2.0.0"
//    val postgres = "com.github.tminglei" %% "slick-pg" % "0.15.0-M4"
//    val postgres_json = "com.github.tminglei" %% "slick-pg_play-json" % "0.15.0-M4"
//    val postgres_yoda = "com.github.tminglei" %% "slick-pg_joda-time" % "0.15.0-M4"
    val postgres = "com.github.tminglei" %% "slick-pg" % "0.14.6"
    val postgres_json = "com.github.tminglei" %% "slick-pg_play-json" % "0.14.6"
    val postgres_yoda = "com.github.tminglei" %% "slick-pg_joda-time" % "0.14.6"
    val yoda = "joda-time" % "joda-time" % "2.9.7"
  }
}
